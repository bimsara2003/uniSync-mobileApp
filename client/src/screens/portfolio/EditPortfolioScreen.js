    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      <ScrollView contentContainerStyle={{ padding: 20 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 24 }}>
          ...
          <Text style={{ fontSize: 20, fontWeight: "700", color: "#0f172a" }}>Edit Portfolio Profile</Text>
        </View>
        ...
        <Field label="GitHub URL">
          <TextInput
            value={gitHub} onChangeText={setGitHub}
        ...
        <View style={{
          ...
          <Text style={{ fontSize: 14, color: "#0f172a", fontWeight: "500" }}>Public profile</Text>
          <Switch value={isPublic} onValueChange={setIsPublic} trackColor={{ true: "#0ea5e9" }} />
        </View>
