...
const CATEGORIES = ["ALL", "ACADEMIC", "SPORTS", "SOCIETY", "CULTURAL", "CAREER"];
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      ...
      <View style={{
        ...
        <Text style={{ fontSize: 22, fontWeight: "700", color: "#0f172a" }}>Events</Text>
        {isRep && (
          <TouchableOpacity
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={{ alignItems: "center", marginTop: 60 }}>
              ...
              <Text style={{ fontSize: 15, color: "#94a3b8" }}>No events found</Text>
            </View>
          }
          renderItem={({ item }) => (
            <EventCard
