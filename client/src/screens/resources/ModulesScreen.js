    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      <View style={{ padding: 16 }}>
        ...
        >
          ...
          <Text style={{ fontSize: 14, color: "#0f172a", marginHorizontal: 6 }}>
            ›
          </Text>
          <TouchableOpacity
            onPress={() => navigation.navigate("DepartmentsList", { faculty })}
          >
            <Text style={{ fontSize: 14, color: "#0f172a" }}>
              {department.name}
            </Text>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              >
                <Text
                  style={{ fontWeight: "bold", color: "#475569", fontSize: 12 }}
                >
                  {item.code}
                </Text>
              </View>
