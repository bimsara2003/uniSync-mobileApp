    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "#f8fafc" }}>
      <View style={{ padding: 16 }}>
        ...
        <View style={{ flexDirection: "row", alignItems: "center", marginBottom: 16 }}>
          <Text style={{ fontSize: 16, fontWeight: "bold", color: "#0f172a" }}>Faculty</Text>
          <Text style={{ fontSize: 16, color: "#cbd5e1", marginHorizontal: 8 }}>›</Text>
          <Text style={{ fontSize: 16, color: "#94a3b8" }}>Department</Text>
          <Text style={{ fontSize: 16, color: "#cbd5e1", marginHorizontal: 8 }}>›</Text>
      ...
      {loading ? (
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <TouchableOpacity
              onPress={() => navigation.navigate("DepartmentsList", { faculty: item })}
              style={{
                backgroundColor: "#fff",
                borderRadius: 12,
                padding: 16,
            ...
            >
              <View style={{
                width: 48, height: 48, borderRadius: 10, backgroundColor: "#eff6ff",
          ...
          ListFooterComponent={
            <View style={{
              ...
              <Text style={{ color: "#bfdbfe", fontSize: 15, lineHeight: 22, opacity: 0.9 }}>
                Access over verified study materials uploaded by peers and professors.
              </Text>
            </View>
          }
        />
